...
values
    ...
    ("LOC_CORPORATION_HD_FOOD_BONUS_DESCRIPTION",       "{LOC_INDUSTRY_BONUS_HD_PREFIX}{LOC_INDUSTRY_HD_FOOD_BONUS_DESCRIPTION}[NEWLINE]{LOC_CORPORATION_BONUS_HD_PREFIX}+1 [ICON_Food] Food and +3 [ICON_Gold] Gold for all districts and Wonders adjacent to river, on or adjacent to Shallow Sea and Lake."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_CORPORATION_HD_FOOD_BONUS_DESCRIPTION",       "{LOC_INDUSTRY_BONUS_HD_PREFIX}{LOC_INDUSTRY_HD_FOOD_BONUS_DESCRIPTION}[NEWLINE]{LOC_CORPORATION_BONUS_HD_PREFIX}所有相邻河流、相邻或位于浅海或湖泊的区域和奇观+1 [ICON_Food] 食物，+3 [ICON_Gold] 金币。"),
...
values
    ...
    ("zh_Hans_CN",  "LOC_IMPROVEMENT_LEU_CONTAINER_PORT_DESCRIPTION",  "所有行业和公司+3 [ICON_GOLD] 金币。所有 [ICON_TRADEROUTE] 贸易路线+3 [ICON_GOLD] 金币。本城来自 [ICON_GREATWORK_PRODUCT] 产品的 [ICON_TOURISM] 旅游业绩+50%。[NEWLINE][NEWLINE]必须建在与加成或奢侈资源相邻，且与陆地相邻的浅海或湖泊单元格上。无法建在另一座集装箱码头旁。每个城市仅限建造一座。"),
...
--jnr新内容
    ...
    "提供等同于单元格魅力的[ICON_Tourism]旅游业绩。只能建造在必须建造在与浅海相邻的沙漠、平原或草原上。只能建造在惊艳魅力的单元格上。"),
    ("zh_Hans_CN", 
