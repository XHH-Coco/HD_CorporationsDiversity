insert or replace into EnglishText (Tag, Text) values
  ...
  ("LOC_IMPROVEMENT_LEU_WAREHOUSE_DESCRIPTION",           "+1 [ICON_FOOD] Food to Agrarian Improvement in this city. +1 [ICON_PRODUCTION] Production to Exploitative Improvement in this city. +3 [ICON_GOLD] Gold to Commercial Improvement in this city. +1 [ICON_PRODUCTION] Production to all [ICON_TRADEROUTE] Trade Routes. [ICON_GREATWORK_PRODUCT] Products provide +50% [ICON_TOURISM] Tourism in this city. [NEWLINE][NEWLINE]Must be built on a land tile Cannot be built Marsh, Swamp or Geothermal Fissure tiles. Only one may be built in each city, and may not be built adjacent to another Warehouse."),
  -- 埠头
  ("LOC_IMPROVEMENT_LEU_CONTAINER_PORT_NAME",             "Pier"),
  ("LOC_IMPROVEMENT_LEU_CONTAINER_PORT_DESCRIPTION",      "+1 [ICON_FOOD] Food to Agrarian Improvement in this city. +1 [ICON_PRODUCTION] Production to Exploitative Improvement in this city. +3 [ICON_GOLD] Gold to Commercial Improvement in this city. +3 [ICON_GOLD] Gold to all [ICON_TRADEROUTE] Trade Routes. [ICON_GREATWORK_PRODUCT] Products provide +50% [ICON_TOURISM] Tourism in this city. [NEWLINE][NEWLINE]Must be built on a Shallow Sea and Lake tile adjacent to land. Only one may be built in each city, and may not be built adjacent to another Pier."),
  -- 火车站
  ("LOC_IMPROVEMENT_LEU_STATION_DESCRIPTION",             "Railroads are instantly built on current and adjacent passable land tiles. Each type of adjacent Specialized districts or adjacent Aqueduct provide corresponding yield to International [ICON_TradeRoute] Trade Routes from this city. This bonus is doubled if this city is fully [ICON_POWER] Powered. Improvements and [ICON_GREATWORK_PRODUCT] Products of this City provided +100% [ICON_TOURISM] Tourism. [NEWLINE][NEWLINE]Cannot be built Marsh, Swamp or Geothermal Fissure tiles. Only one may be built in each city, and may not be built adjacent to another Station."),
  -- 特产商行
  ("LOC_IMPROVEMENT_LEU_TRANSNATIONAL_NAME",              "Specialty Shop"),
  ("LOC_IMPROVEMENT_LEU_TRANSNATIONAL_DESCRIPTION",       "Built by Overseas Investor. Provides unique bonuses to its city based on the resource's usages; after completing Colonialism Civic, additionally provides unique nationwide bonuses. Each city can only establish one Specialty Shop or Entrance Harbor in total.[NEWLINE][NEWLINE]Cannot be completely destroyed by natural disasters."),
  -- 进口商埠
  ...
  ("LOC_IMPROVEMENT_TRANSNATIONAL_DISABLED",                        "[COLOR:Red]There are no city-states available for selection.[ENDCOLOR]"),
  ("LOC_IMPROVEMENT_TRANSNATIONAL_CITY_DISABLED",                   "[COLOR:Red]This city can only build at most {1_Num} Specialty {1_Num : plural 1?Shop; other?Shops;} or Entrance {1_Num : plural 1?Harbor; other?Harbors;}.[ENDCOLOR]"),
...
insert or replace into LocalizedText (Language, Tag, Text) values
  ...
  ("zh_Hans_CN",  "LOC_IMPROVEMENT_IC_BONUS_CITY_DISABLED",             "[COLOR:Red]本城最多只能创立{1_Num}座改良加成资源的行业或公司。[ENDCOLOR]"),
  ("zh_Hans_CN",  "LOC_IMPROVEMENT_IC_STRATEGIC_CITY_DISABLED",         "[COLOR:Red]本城最多只能创立{1_Num}座改良战略资源的行业或公司。[ENDCOLOR]"),
  ("zh_Hans_CN",  "LOC_IMPROVEMENT_INDUSTRY_PLAYER_DISABLED",           "[COLOR:Red]你已经创立了 {1_Icon} {2_Resource}行业或公司。[ENDCOLOR]"),
  ("zh_Hans_CN",  "LOC_IMPROVEMENT_CORPORATION_GAME_DISABLED",          "[COLOR:Red]世界上已经创立了 {1_Icon} {2_Resource}公司。[ENDCOLOR]"),
  ...
  ("zh_Hans_CN",  "LOC_IMPROVEMENT_LEU_WAREHOUSE_DESCRIPTION",          "本城的农业生产改良+1 [ICON_FOOD] 食物，工业开发改良+1 [ICON_PRODUCTION] 生产力，贸易往来改良+3 [ICON_GOLD] 金币。所有 [ICON_TRADEROUTE] 贸易路线+1 [ICON_PRODUCTION] 生产力。本城来自 [ICON_GREATWORK_PRODUCT] 产品的 [ICON_TOURISM] 旅游业绩+50%。[NEWLINE][NEWLINE]必须建在陆地单元格上。无法建在沼泽或地热裂缝上。无法建在另一座仓库旁。每个城市仅限建造一座。"),
  -- 埠头
  ("zh_Hans_CN",  "LOC_IMPROVEMENT_LEU_CONTAINER_PORT_NAME",            "埠头"),
  ("zh_Hans_CN",  "LOC_IMPROVEMENT_LEU_CONTAINER_PORT_DESCRIPTION",     "本城的农业生产改良+1 [ICON_FOOD] 食物，工业开发改良+1 [ICON_PRODUCTION] 生产力，贸易往来改良+3 [ICON_GOLD] 金币。所有 [ICON_TRADEROUTE] 贸易路线+3 [ICON_GOLD] 金币。本城来自 [ICON_GREATWORK_PRODUCT] 产品的 [ICON_TOURISM] 旅游业绩+50%。[NEWLINE][NEWLINE]必须建在与陆地相邻的浅海或湖泊单元格上。无法建在另一座埠头旁。每个城市仅限建造一座。"),
  -- 火车站
  ("zh_Hans_CN",  "LOC_IMPROVEMENT_LEU_STATION_DESCRIPTION",            "在所在单元格和所有相邻的可通行陆地单元格上自动建造铁路。相邻的每种专业化区域或水渠为本城出发的国际 [ICON_TradeRoute] 贸易路线提供对应产出；此城 [ICON_POWER] 供电充足时效果翻倍。本城的改良和 [ICON_GREATWORK_PRODUCT] 产品提供的 [ICON_TOURISM] 旅游业绩+100%。[NEWLINE][NEWLINE]不能建在沼泽或地热裂缝上，一座城市只能拥有一个火车站，火车站不能与另一个火车站相邻。"),
  -- 特产商行
  ("zh_Hans_CN",  "LOC_IMPROVEMENT_LEU_TRANSNATIONAL_NAME",             "特产商行"),
  ("zh_Hans_CN",  "LOC_IMPROVEMENT_LEU_TRANSNATIONAL_DESCRIPTION",      "由海外投资人创立，根据资源的用途为其所在城市带来独特加成效果；解锁“殖民主义”后，带来全国性的独特加成效果。每座城市总共仅能创立一座特产商行或进口商埠。[NEWLINE][NEWLINE]无法被自然灾害完全摧毁。"),
  -- 进口商埠
  ("zh_Hans_CN",  "LOC_IMPROVEMENT_LEU_TRANSNATIONAL_SEA_NAME",         "进口商埠"),
  ("zh_Hans_CN",  "LOC_IMPROVEMENT_LEU_TRANSNATIONAL_SEA_DESCRIPTION",  "由海外投资人创立，根据资源的用途为其所在城市带来独特加成效果；解锁“殖民主义”后，带来全国性的独特加成效果。每座城市总共仅能创立一座特产商行或进口商埠。[NEWLINE][NEWLINE]无法被自然灾害完全摧毁。"),
  ...
  ("zh_Hans_CN",  "LOC_IMPROVEMENT_TRANSNATIONAL_DISABLED",                     "[COLOR:Red]没有符合条件的城邦可供选择。[ENDCOLOR]"),
  ("zh_Hans_CN",  "LOC_IMPROVEMENT_TRANSNATIONAL_CITY_DISABLED",                "[COLOR:Red]本城最多只能创立{1_Num}座特产商行或进口商埠。[ENDCOLOR]"),
