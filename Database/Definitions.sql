...
-- =====================================================================================================================================
insert or replace into Improvements (ImprovementType, Name, Description, PlunderType, PlunderAmount, Icon, OnePerCity, Removable) values
	('IMPROVEMENT_INDUSTRY_BONUS', 				'LOC_IMPROVEMENT_INDUSTRY_BONUS_NAME', 				'LOC_IMPROVEMENT_INDUSTRY_DESCRIPTION', 							'PLUNDER_GOLD', 50, 'ICON_IMPROVEMENT_INDUSTRY', 		1, 1),
	('IMPROVEMENT_INDUSTRY_STRATEGIC', 		'LOC_IMPROVEMENT_INDUSTRY_STRATEGIC_NAME', 		'LOC_IMPROVEMENT_INDUSTRY_DESCRIPTION', 							'PLUNDER_GOLD', 50, 'ICON_IMPROVEMENT_INDUSTRY', 		1, 1),
	('IMPROVEMENT_CORPORATION_BONUS', 		'LOC_IMPROVEMENT_CORPORATION_BONUS_NAME', 		'LOC_IMPROVEMENT_CORPORATION_EXPANSION2_DESCRIPTION', 'PLUNDER_GOLD', 50, 'ICON_IMPROVEMENT_CORPORATION', 1, 0),
	('IMPROVEMENT_CORPORATION_STRATEGIC', 'LOC_IMPROVEMENT_CORPORATION_STRATEGIC_NAME', 'LOC_IMPROVEMENT_CORPORATION_EXPANSION2_DESCRIPTION', 'PLUNDER_GOLD', 50, 'ICON_IMPROVEMENT_CORPORATION', 1, 0);

insert or ignore into Improvements_XP2 (ImprovementType, DisasterResistant) values
	('IMPROVEMENT_CORPORATION_BONUS', 		1),
	('IMPROVEMENT_CORPORATION_STRATEGIC', 1);
