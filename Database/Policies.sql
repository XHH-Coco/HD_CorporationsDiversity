...
insert or replace into Policies (PolicyType, Name, Description, PrereqCivic, PrereqTech, GovernmentSlotType) values
	('POLICY_WAREHOUSE_MANAGEMENT',		'LOC_POLICY_WAREHOUSE_MANAGEMENT_NAME',			'LOC_POLICY_WAREHOUSE_MANAGEMENT_DESCRIPTION',		null,		'TECH_APPRENTICESHIP',	        	'SLOT_ECONOMIC'),
...
insert or replace into Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) values
	...
	('WAREHOUSE_MANAGEMENT_COMMERCIAL_HUB_BONUS',		  'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_MODIFIER',	'HD_WAREHOUSE_MANAGEMENT_COMMERCIAL_HUB_REQUIREMENTS'),
	('WAREHOUSE_MANAGEMENT_HARBOR_BONUS',						  'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_MODIFIER',	'HD_WAREHOUSE_MANAGEMENT_HARBOR_REQUIREMENTS'),
	('WAREHOUSE_MANAGEMENT_INDUSTRIAL_ZONE_BONUS',	  'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_MODIFIER',	'HD_WAREHOUSE_MANAGEMENT_INDUSTRIAL_ZONE_REQUIREMENTS'),
	('AUTO_STEREO_WAREHOUSE_COMMERCIAL_HUB_BONUS',		'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_MODIFIER',	'HD_WAREHOUSE_MANAGEMENT_COMMERCIAL_HUB_REQUIREMENTS'),
	('AUTO_STEREO_WAREHOUSE_HARBOR_BONUS',						'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_MODIFIER',	'HD_WAREHOUSE_MANAGEMENT_HARBOR_REQUIREMENTS'),
	('AUTO_STEREO_WAREHOUSE_INDUSTRIAL_ZONE_BONUS',		'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_MODIFIER',	'HD_WAREHOUSE_MANAGEMENT_INDUSTRIAL_ZONE_REQUIREMENTS');
