...
insert or ignore into GovernorPromotionModifiers (GovernorPromotionType, ModifierId) values
  -- 维克多 军备研究部
  ('GOVERNOR_PROMOTION_HD_DEFENDER_RIGHT_3', 'HD_GOVERNOR_DEFENDER_RIGHT_3_MILITARY_ENGINEERING_ABILITY'),
...
insert or ignore into Modifiers (ModifierId, ModifierType, Permanent, SubjectRequirementSetId) values
  -- 维克多 军备研究部
  ('HD_GOVERNOR_DEFENDER_RIGHT_3_MILITARY_ENGINEERING_ABILITY',         'MODIFIER_SINGLE_CITY_GRANT_ABILITY_FOR_TRAINED_UNITS',                 1,  NULL),
  ...
  -- 马格努斯 实体产业
  ('HD_GOVERNOR_MANAGER_LEFT_2_BUILDER_ABILITY',                        'MODIFIER_SINGLE_CITY_GRANT_ABILITY_FOR_TRAINED_UNITS',                 1,  NULL),
  -- 瑞娜 包税制度
...
insert or ignore into ModifierArguments (ModifierId, Name, Value) values
  -- 维克多 军备研究部
  ('HD_GOVERNOR_DEFENDER_RIGHT_3_MILITARY_ENGINEERING_ABILITY',         'AbilityType',            'ABILITY_HD_GOVERNOR_DEFENDER_RIGHT_3_MILITARY_ENGINEERING_ABILITY'),
