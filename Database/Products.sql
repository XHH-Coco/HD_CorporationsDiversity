...
insert or ignore into Projects (ProjectType, Name, ShortName, Description, Cost, PrereqTech, AdvisorType, UnlocksFromEffect) values
  ('PROJECT_HD_BATCH_PRODUCTS_SMALL', 'LOC_PROJECT_HD_BATCH_PRODUCTS_SMALL_NAME', 'LOC_PROJECT_HD_BATCH_PRODUCTS_SMALL_NAME', 'LOC_PROJECT_HD_BATCH_PRODUCTS_SMALL_DESCRIPTION',  200,  'TECH_APPRENTICESHIP',    'ADVISOR_GENERIC', 0),
  ...
  ('PROJECT_HD_BATCH_PRODUCTS_BIG',   'LOC_PROJECT_HD_BATCH_PRODUCTS_BIG_NAME',   'LOC_PROJECT_HD_BATCH_PRODUCTS_BIG_NAME',   'LOC_PROJECT_HD_BATCH_PRODUCTS_BIG_DESCRIPTION',    1200, 'TECH_INDUSTRIALIZATION', 'ADVISOR_GENERIC', 0);
...
insert or ignore into HD_ProductYields (Category, YieldType, YieldChange) values
  ('CROPS',           'YIELD_FOOD',				5),
  ('AGRICULTURE',     'YIELD_FOOD',				4),
  ('AGRICULTURE',     'YIELD_SCIENCE',		1),
  ('CUISINE',         'YIELD_FOOD',				4),
  ('CUISINE',         'YIELD_GOLD',				3),
  ('FRUIT',           'YIELD_FOOD',				3),
  ('FRUIT',           'YIELD_GOLD',				6),
  ('VEGETABLE',       'YIELD_FOOD',		    1),
  ('VEGETABLE',       'YIELD_SCIENCE',		1),
  ('VEGETABLE',       'YIELD_GOLD',				9),
  ('BREWING',         'YIELD_FOOD',				1),
  ('BREWING',         'YIELD_CULTURE',		4),
  ('BEVERAGE',        'YIELD_FOOD',				2),
  ('BEVERAGE',        'YIELD_CULTURE',		3),
  ('OIL',             'YIELD_PRODUCTION',	3),
  ('OIL',             'YIELD_GOLD',				6),
  ('LEATHER',         'YIELD_PRODUCTION',	2),
  ('LEATHER',         'YIELD_GOLD',				9),
  ('CLOTH',           'YIELD_CULTURE',		2),
  ('CLOTH',           'YIELD_GOLD',				9),
  ('CONSTRUCTION',    'YIELD_PRODUCTION',	5),
  ('FUEL',            'YIELD_PRODUCTION',	3),
  ('FUEL',            'YIELD_GOLD',				6),
  ('CHEMISTRY',       'YIELD_PRODUCTION',	1),
  ('CHEMISTRY',       'YIELD_SCIENCE',		4),
  ('METALLURGY',      'YIELD_PRODUCTION',	4),
  ('METALLURGY',      'YIELD_SCIENCE',		1),
  ('MINTING',         'YIELD_GOLD',				15),
  ('TRANSIT',         'YIELD_PRODUCTION',	1),
  ('TRANSIT',         'YIELD_GOLD',				12),
  ('SEASONING',       'YIELD_FOOD',				1),
  ('SEASONING',       'YIELD_GOLD',				12),
  ('SEAFOOD',         'YIELD_FOOD',				5),
  ('MARINE_PRODUCTS', 'YIELD_PRODUCTION',	5),
  ('SEA_BEAST',       'YIELD_SCIENCE',		2),
  ('SEA_BEAST',       'YIELD_CULTURE',		2),
  ('SEA_BEAST',       'YIELD_GOLD',		    3),
  ('CELEBRATION',     'YIELD_FAITH',			6),
  ('CELEBRATION',     'YIELD_GOLD',			  3),
  ('MEDICINE',        'YIELD_SCIENCE',		5),
  ('STATIONERY',      'YIELD_SCIENCE',		3),
  ('STATIONERY',      'YIELD_CULTURE',		2),
  ('ART',             'YIELD_CULTURE',		5),
  ('DECORATION',      'YIELD_CULTURE',		3),
  ('DECORATION',      'YIELD_GOLD',				6),
  ('ORNAMENTAL',      'YIELD_SCIENCE',		2),
  ('ORNAMENTAL',      'YIELD_CULTURE',		3),
  ('BEAST',           'YIELD_SCIENCE',		2),
  ('BEAST',           'YIELD_CULTURE',		1),
  ('BEAST',           'YIELD_FAITH',			3),
  ('HOUSEHOLD',       'YIELD_PRODUCTION',	4),
  ('HOUSEHOLD',       'YIELD_CULTURE',		1),

  ('TOYS',       			'YIELD_SCIENCE',		5),
  ('TOYS',       			'YIELD_GOLD',				15),
  ('COSMETICS',       'YIELD_CULTURE',		5),
  ('COSMETICS',       'YIELD_GOLD',				15),
  ('JEANS',       		'YIELD_PRODUCTION',	6),
  ('JEANS',       		'YIELD_FAITH',			6),
  ('PERFUME',      		'YIELD_SCIENCE',		5),
  ('PERFUME',      		'YIELD_CULTURE',		5),
  ('PERFUME',      		'YIELD_GOLD',				15);
