...
insert or ignore into CivicModifiers (CivicType, ModifierId) values
	('CIVIC_COLONIALISM',	'HD_CITY_UNLOCK_SPECIALTY_SHOP_CORPORATION'),
	('CIVIC_COLONIALISM',	'HD_CITY_UNLOCK_ENTRANCE_HARBOR_CORPORATION');
...
insert or replace into Modifiers (ModifierId, ModifierType) values
	...
	('HD_CITY_UNLOCK_SPECIALTY_SHOP_CORPORATION', 	'MODIFIER_PLAYER_CITIES_ADJUST_PROPERTY'),
	('HD_CITY_UNLOCK_ENTRANCE_HARBOR_CORPORATION', 	'MODIFIER_PLAYER_CITIES_ADJUST_PROPERTY');
