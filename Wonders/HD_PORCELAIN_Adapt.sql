...
insert or ignore into Projects_XP2 (ProjectType, RequiredBuilding) values
	('PROJECT_CREATE_PRODUCT_PORCELAIN', 'BUILDING_PORCELAIN_TOWER');
...
-- 产品定义
-- =====================================================================================================================================
CREATE TEMPORARY TABLE HD_PORCELAIN_Products ('Num' TEXT);
...
insert or replace into GreatWork_YieldChanges (GreatWorkType, YieldType, YieldChange) select
...
-- 主题化
insert or ignore into HD_Monopoly_Categories (Category) values ('PORCELAIN');
insert or ignore into HD_Monopoly_Resource_Categories (ResourceType, Category) values ('RESOURCE_PORCELAIN','PORCELAIN');