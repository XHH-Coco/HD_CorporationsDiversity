...
insert or ignore into GreatWork_YieldChanges (GreatWorkType, YieldType, YieldChange) values
	('GREATWORK_PRODUCT_KHALIFA_1',		'YIELD_FOOD',				16),
	('GREATWORK_PRODUCT_KHALIFA_1',		'YIELD_FAITH',			24),
	('GREATWORK_PRODUCT_KHALIFA_2',		'YIELD_FOOD',				16),
	('GREATWORK_PRODUCT_KHALIFA_2',		'YIELD_PRODUCTION', 16),
	('GREATWORK_PRODUCT_KHALIFA_3',		'YIELD_GOLD',				96),
	('GREATWORK_PRODUCT_KHALIFA_4',		'YIELD_CULTURE',		16),
	('GREATWORK_PRODUCT_KHALIFA_4',		'YIELD_SCIENCE',		16),
	('GREATWORK_PRODUCT_KHALIFA_5',		'YIELD_SCIENCE',		32),
	('GREATWORK_PRODUCT_KHALIFA_6',		'YIELD_FOOD',				16),
	('GREATWORK_PRODUCT_KHALIFA_6',		'YIELD_GOLD',				48),
	('GREATWORK_PRODUCT_KHALIFA_7',		'YIELD_CULTURE',		32),
	('GREATWORK_PRODUCT_KHALIFA_8',		'YIELD_CULTURE',		16),
	('GREATWORK_PRODUCT_KHALIFA_8',		'YIELD_GOLD',				48);
